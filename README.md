...
![version](https://img.shields.io/static/v1?label=version&message=0.2.4u-SNAPSHOT&labelColor=212121&color=2962ff&style=flat)

- [Maven](https://s01.oss.sonatype.org/content/repositories/snapshots/com/github/kepocnhh/KotlinExtension.Lwjgl/0.2.4u-SNAPSHOT)
...
dependencies {
    implementation("com.github.kepocnhh:KotlinExtension.Lwjgl:0.2.4u-SNAPSHOT")
}
```
