...
@Deprecated("sp.kx.math.px")
internal fun MutableMatrix.px(fov: Double, width: Double, height: Double, n: Double, f: Double) {
    val right = n * kotlin.math.tan(fov / 2)
    val top = right * height / width
    //
    val a00 = n / right; val a01 = 0.0;     val a02 = 0.0;                   val a03 = 0.0
    val a10 = 0.0;       val a11 = n / top; val a12 = 0.0;                   val a13 = 0.0
    val a20 = 0.0;       val a21 = 0.0;     val a22 = (f + n) / (n - f);     val a23 = -1.0
    val a30 = 0.0;       val a31 = 0.0;     val a32 = 2.0 * f * n / (n - f); val a33 = 0.0
    //
...
@Deprecated("sp.kx.math.perspective")
internal fun MutableMatrix.perspective(fov: Double, n: Double, f: Double) {
    val s = 1 / kotlin.math.tan(fov / kotlin.math.PI)
    val a00 = s;   val a01 = 0.0; val a02 = 0.0;               val a03 = 0.0
    val a10 = 0.0; val a11 = s;   val a12 = 0.0;               val a13 = 0.0
    val a20 = 0.0; val a21 = 0.0; val a22 = n / (n - f);       val a23 = -1.0
    val a30 = 0.0; val a31 = 0.0; val a32 = (n * f) / (n - f); val a33 = 0.0
    //
    val m00 = this.m00 * a00 + this.m01 * a10 + this.m02 * a20 + this.m03 * a30
    val m01 = this.m00 * a01 + this.m01 * a11 + this.m02 * a21 + this.m03 * a31
    val m02 = this.m00 * a02 + this.m01 * a12 + this.m02 * a22 + this.m03 * a32
...
@Deprecated("sp.kx.math.perspective")
internal fun MutableMatrix.perspective(fov: Double, width: Double, height: Double, n: Double, f: Double) {
    val s = kotlin.math.tan(fov / 2)
    val a = height / width
    val r = n * s
    val t = r / a
    val a00 = n / r; val a01 = 0.0; val a02 = 0.0; val a03 = 0.0
    val a10 = 0.0;   val a11 = 0.0; val a12 = 0.0; val a13 = 0.0
    val a20 = 0.0;   val a21 = 0.0; val a22 = 0.0; val a23 = 0.0
    val a30 = 0.0;   val a31 = 0.0; val a32 = 0.0; val a33 = 0.0
    //
    val m00 = this.m00 * a00 + this.m01 * a10 + this.m02 * a20 + this.m03 * a30
    val m01 = this.m00 * a01 + this.m01 * a11 + this.m02 * a21 + this.m03 * a31
    val m02 = this.m00 * a02 + this.m01 * a12 + this.m02 * a22 + this.m03 * a32
...
@Deprecated("sp.kx.math.perspective")
internal fun MutableMatrix.perspective1(l: Double, t: Double, r: Double, b: Double, n: Double, f: Double) {
    val a00 = (2.0 * n) / (r - l); val a01 = 0.0;                 val a02 = (r + l) / (r - l); val a03 = 0.0
    val a10 = 0.0;                 val a11 = (2.0 * n) / (t - b); val a12 = (t + b) / (t - b); val a13 = 0.0
    val a20 = 0.0;                 val a21 = 0.0;                 val a22 = (n + f) / (n - f); val a23 = (2.0 * f * n) / (n - f)
    val a30 = 0.0;                 val a31 = 0.0;                 val a32 = -1.0;              val a33 = 0.0
    //
    val m00 = this.m00 * a00 + this.m01 * a10 + this.m02 * a20 + this.m03 * a30
    val m01 = this.m00 * a01 + this.m01 * a11 + this.m02 * a21 + this.m03 * a31
    val m02 = this.m00 * a02 + this.m01 * a12 + this.m02 * a22 + this.m03 * a32
